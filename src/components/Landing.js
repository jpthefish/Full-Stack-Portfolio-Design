    ...
    return (
        <main>
            ...
            <section className="cream">
                ...
                <p>Participate in an online chatroom with Google sign-in authentication. The chatroom adheres to community guidelines and will automatically filter inappropriate language. </p>
                <div className="wave">
