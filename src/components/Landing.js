    ...
    return (
        <main>
            <section className="antique">
                ...
                <p>This website is a collaborative platform created and maintained by J.P. Haynes with the goal to advance knowledge and showcase creative work. The platform is continually revised and updated with new features through the help of innovative and insightful user feedback.</p>
            </section>
            <section className="cream">
                ...
                <p>Explore a growing collection of collaborative research projects in the academic disciplines of computer science, computational sociology, demography, and economics.</p>
            ...
            <section className="antique">
                ...
                <p>Participate in an online chatroom with Google sign-in authentication. The chatroom adheres to community guidelines while filtering profanity and ensuring security via server-side code.</p>
            ...
            <section className="cream">
                ...
                <p>This website continually adds and refines content and features through the help of user feedback. You can message the developer directly to share new ideas, ask questions, or report concerns.</p>
                <div className="wave">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                        <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill"></path>
                    </svg>
            ...
            <p>Explore the developer's background, skills, and other projects and connect through LinkedIn and Github. </p>
            <div className="wave">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                    <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill"></path>
                </svg>
