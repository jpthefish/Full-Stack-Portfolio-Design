    ...
    return (
        <main>
            ...
            <section className="cream">
                ...
                <p>Participate in an online chatroom with Google sign-in authentication. The chatroom adheres to community guidelines and will filter profanity and ensure security via server side code.</p>
                <div className="wave">
            ...
            <section className="antique">
                ...
                <p>Play an on-screen piano with mouse and keyboard interactivity to quickly capture and demonstrate music ideas (currently supported only on desktop.)</p>
                <div className="wave">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                        <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill"></path>
                    </svg>
            ...
            <section className="cream">
                ...
                <p>This website continually adds and refines features through the help and guidance of user feedback. You can message the developer directly to share new ideas, ask questions, or report concerns.</p>
                <div className="wave">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                        <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill"></path>
                    </svg>
            ...
            <p>Explore the developer's background, skills, and other engineering projects and connect through LinkedIn and Github. </p>
            <div className="wave">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                    <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill"></path>
                </svg>
