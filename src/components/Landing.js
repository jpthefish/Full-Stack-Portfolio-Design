    ...
    return (
        <main>
            <section className="antique">
                ...
                <p>This website is a collaborative platform created by J.P. Haynes with the goal to advance knowledge and showcase work. The platform is continually updated with new features and content through the help of insightful user feedback.</p>
            </section>
