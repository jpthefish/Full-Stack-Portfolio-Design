    ...
    return (
        <main>
            <section className="antique">
                ...
                <p>This website is a collaborative platform created by J.P. Haynes with the goal to advance knowledge and showcase creative work. The platform is continually updated with new features and content through the help of innovative and insightful user feedback.</p>
            </section>
            <section className="cream">
                ...
                <p>Explore a growing collection of collaborative research projects in the academic disciplines of computer science, demography, and economics.</p>
