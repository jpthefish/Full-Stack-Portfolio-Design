    ...
    return (
        <main>
            ...
            <section className="cream">
                <h1>My Experience</h1>
                <p>In addition to this platform, other projects hosted on GitHub include an interactive sorting algorithm visualizer as well as website templates I've developed for businesses. I have design and development experience in several languages/frameworks, especially Python, SQL, and Javascript (with React.js).</p>
                <div className="wave">
