    ...
    return (
        <main>
            <section className="antique">
                ...
                <p>Explore a growing collection of infographics and publications viewed by 5000+ daily across the internet in the academic disciplines of computer science, computational sociology, demography, and economics.</p>
            </section>
